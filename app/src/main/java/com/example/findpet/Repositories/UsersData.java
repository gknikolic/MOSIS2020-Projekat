package com.example.findpet.Repositories;
...
import com.example.findpet.RepositoryEventListeners.UsersListEventListener;
import com.example.findpet.data_models.User;
...
//    }
    ...
    public void updateLocation(Location lastLocation) {
        if (!currentUserUID.equals("")) {
            dbReference.child("korisnici").child(currentUserUID).child("Latitude").setValue(String.valueOf(lastLocation.getLatitude()));
            dbReference.child("korisnici").child(currentUserUID).child("Longitude").setValue(String.valueOf(lastLocation.getLongitude()));
        }
    }
